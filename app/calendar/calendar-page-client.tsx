...
export function EarningsCalendarPageClient() {
  ...
  useEffect(() => {
    setWeekStartISO(startOfWeekIso(todayIso("America/New_York")));
  }, []);
  ...
  const weekEndISO = weekStartISO ? addDaysIso(weekStartISO, 6) : null;

  const visibleEvents =
    weekStartISO && weekEndISO
      ? EARNINGS_EVENTS.filter(
